...
contract DuckDuckGoose is Ownable, ERC721 {
    ...
    function mint(uint256 quantity) external payable {
        ...
        for(uint256 i = 0; i < quantity; i++) {
            ...
            if(_tokenIdTracker % hatchCycle == 0) {
                hatch();
            }
        }
    }
