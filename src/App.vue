                    ...
                    <div class="carousel slide text-center text-secondary" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <small><strong class="text-success">eggs</strong> are hatched every <strong class="text-dark"><i>{{ hatchCycle }} mints</i></strong>!</small>
                            </div>
                            <div class="carousel-item">
                                <small>The current prize for hatching a <strong class="text-success">goose</strong> is <strong class="text-dark"><i>{{ prizeBank }} ETH</i></strong>!</small>
                            </div>
                            <div class="carousel-item">
                            ...
                            <div class="carousel-item">
                                <small>only <strong class="text-dark"><i>{{ hatchCycle - eggs }}</i></strong> mints left before the next <strong class="text-success">hatchening</strong>!</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    const contractAddress = '0xd7C26fA1bC9E630891e08049ab27403620516C4A';
